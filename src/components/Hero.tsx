...
const desktopImages = [
  { src: "/images/hero-slide-1.jpg", alt: "Modern Jospo Air Cooler" },
  { src: "/images/hero-slide-5.jpg", alt: "Jospo Air Cooler Lineup" },
];

const mobileImages = [
  { src: "/images/hero-mobile-1.jpg", alt: "Modern Jospo Air Cooler" },
  { src: "/images/hero-mobile-2.jpg", alt: "Jospo Air Cooler Lineup" },
];
    ...
    <section id="home" ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div className="absolute inset-0 z-0" style={{ y: bgY, scale }}>
        ...
        {/* Dynamic Gradient Overlay:
            On desktop: dark on the left (under the text) fading to transparent on the right (where the product is).
            On mobile: uniform dark overlay to ensure centered text readability.
        */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#0B1120]/90 via-[#0D1B2A]/85 to-[#023E8A]/75 lg:bg-gradient-to-r lg:from-[#0B1120]/95 lg:via-[#0B1120]/80 lg:to-transparent z-[1]" />
      </motion.div>
      ...
      <motion.div 
        style={{ opacity }} 
        className="relative z-10 section-container text-center lg:text-left py-32 sm:py-40 flex flex-col items-center lg:items-start"
      >
        <div className="max-w-3xl lg:max-w-2xl mx-auto lg:mx-0">
          {/* Badge */}
          <motion.div
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl md:text-2xl text-white/70 max-w-3xl mx-auto lg:mx-0 mb-10 leading-relaxed"
          >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4 mb-14"
          >
          ...
          <motion.div
            ...
            className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-10 max-w-3xl mx-auto lg:mx-0 w-full"
          >
            {stats.map((stat) => (
